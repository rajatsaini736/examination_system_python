...
def instructions():
	...
	tk.Label(root,text="* 10 questions are given for each student.",bg="#99ccff",font="Times 15 bold").pack(anchor=tk.NW)
	tk.Label(root,text="* save & next - this button is used to save your temporary answer and proceed to the next question.",bg="#99ccff",font="Times 15 bold").pack(anchor=tk.NW)
	tk.Label(root,text="* skip ques - this button is used to proceed to the next question without saving it.",bg="#99ccff",font="Times 15 bold").pack(anchor=tk.NW)
	tk.Label(root,text="* prev ques - this button is used to proceed to the previous questionk.",bg="#99ccff",font="Times 15 bold").pack(anchor=tk.NW)
	tk.Label(root,text="*",bg="#99ccff",font="Times 15 bold").pack(anchor=tk.NW)
	tk.Button(root,text="1",width=5,bd=2,padx=2,pady=2).place(x=20,y=160)
	tk.Label(root,text="shows that you have not attempt this question yet.",bg="#99ccff",font="Times 15 bold").place(x=70,y=155)
	tk.Label(root,text="*",bg="#99ccff",font="Times 15 bold").pack(anchor=tk.NW)
	tk.Button(root,text="1",width=5,bd=2,bg="green",padx=2,pady=2).place(x=20,y=190)
	tk.Label(root,text="shows that you have attempt this qusetion.",bg="#99ccff",font="Times 15 bold").place(x=70,y=185)
